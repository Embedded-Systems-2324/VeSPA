...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bruno/gitreps/VeSPA_UartTest/Vivado/vespa_soc/vespa_soc.cache/compile_simlib/vcs"
  fi
