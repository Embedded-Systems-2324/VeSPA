...
HD_PWD='/home/bruno/VivadoProjects/VeSPA_PeripheralsTest/Vivado/vespa_soc/vespa_soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vespa_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vespa_soc_wrapper.tcl -notrace
