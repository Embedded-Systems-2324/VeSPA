...
HD_PWD='/home/bruno/VivadoProjects/VeSPA_PeripheralsTest/Vivado/vespa_soc/vespa_soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vespa_soc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vespa_soc_wrapper.tcl
