...
HD_PWD='/home/bruno/VivadoProjects/GPIO/GPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_Slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_Slave.tcl
