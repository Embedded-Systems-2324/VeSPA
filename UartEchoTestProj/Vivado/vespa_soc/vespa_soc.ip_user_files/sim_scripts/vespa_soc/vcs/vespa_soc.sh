...
design_libs=(xpm xil_defaultlib blk_mem_gen_v8_4_6 fifo_generator_v13_2_8)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
  ...
  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bruno/VivadoProjects/UartEchoTest/Vivado/vespa_soc/vespa_soc.cache/compile_simlib/vcs"
  fi
