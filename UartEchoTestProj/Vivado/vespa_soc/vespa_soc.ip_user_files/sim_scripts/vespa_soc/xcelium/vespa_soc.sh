...
#
# Script generated by Vivado on Wed May 01 16:05:07 WEST 2024
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_6 -libname fifo_generator_v13_2_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib blk_mem_gen_v8_4_6 fifo_generator_v13_2_8)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
  ...
  xmvlog -work fifo_generator_v13_2_8 $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/8915/src" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vespa_soc xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vespa_soc -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bruno/VivadoProjects/UartEchoTest/Vivado/vespa_soc/vespa_soc.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vespa_soc_sc.so .tmp_log xcelium_lib waves.shm c.obj)
