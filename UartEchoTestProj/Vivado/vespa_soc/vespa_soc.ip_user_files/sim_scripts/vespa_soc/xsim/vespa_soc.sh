...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_6 -L fifo_generator_v13_2_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vespa_soc xil_defaultlib.vespa_soc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vespa_soc -key {Behavioral:sim_1:Functional:vespa_soc} -tclbatch cmd.tcl -protoinst "protoinst_files/vespa_soc.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(blk_mem_gen_v8_4_6 fifo_generator_v13_2_8)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vespa_soc.wdb xsim.dir libdpi.so)
