...
#
# Script generated by Vivado on Mon Jun 03 12:12:37 WEST 2024
...
#
# Usage        : VideoMemory.sh
#                VideoMemory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VideoMemory.sh [-reset_run]
#                VideoMemory.sh [-reset_log]
#                VideoMemory.sh [-help]
#
...
#                script (type 'VideoMemory.sh -help' for more information).
#
...
# script info
echo -e "VideoMemory.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VideoMemory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.VideoMemory xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.VideoMemory -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tiago/Desktop/VGAStuff/VGA_working/VGA/VGA.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log VideoMemory_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: VideoMemory.sh [-step]\n\
Usage: VideoMemory.sh [-lib_map_path]\n\
Usage: VideoMemory.sh [-reset_run]\n\
Usage: VideoMemory.sh [-reset_log]\n\
Usage: VideoMemory.sh [-keep_index]\n\
