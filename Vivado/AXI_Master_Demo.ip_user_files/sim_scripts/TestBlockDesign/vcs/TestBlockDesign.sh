...
design_libs=(xpm xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 blk_mem_gen_v8_4_6 axi_bram_ctrl_v4_1_8 generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariolima/Desktop/AXI_Master_Demo/AXI_Master_Demo.cache/compile_simlib/vcs"
  fi
