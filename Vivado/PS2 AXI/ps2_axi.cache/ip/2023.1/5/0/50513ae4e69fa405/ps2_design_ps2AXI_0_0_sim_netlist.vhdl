...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_new is
  ...
  attribute SOFT_HLUTNM of \data_read[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_read[10]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_read[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_read[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_read[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_read[4]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_read[5]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_read[6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_read[7]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_read[8]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_read[9]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of error_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of parity_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \slv_reg0[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \slv_reg0[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \slv_reg0[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \slv_reg0[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \slv_reg0[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \slv_reg0[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \slv_reg0[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \slv_reg0[7]_i_2\ : label is "soft_lutpair4";
...
\key[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
ps2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_new
     port map (
      ...
      ps2_wdata(8 downto 0) => ps2_wdata(8 downto 0),
      ps2_wstrb(0) => ps2_wstrb(1),
      \ps2_wstrb[1]\ => ps2_n_1,
      reset => reset,
      slv_reg0(0) => slv_reg0(8),
      \slv_reg0_reg[8]\ => \slv_reg0[7]_i_3_n_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal n_0_116 : STD_LOGIC;
  signal n_0_118 : STD_LOGIC;
  signal n_0_119 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of i_116 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of i_118 : label is "soft_lutpair15";
