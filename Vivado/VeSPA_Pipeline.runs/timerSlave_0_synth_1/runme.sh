...
HD_PWD='/home/joseleite/Vivado_Projects/Vivado/VeSPA_Pipeline.runs/timerSlave_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timerSlave_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timerSlave_0.tcl
