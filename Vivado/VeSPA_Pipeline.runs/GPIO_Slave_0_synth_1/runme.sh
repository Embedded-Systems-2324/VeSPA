...
HD_PWD='/home/joseleite/Vivado_Projects/Vivado/VeSPA_Pipeline.runs/GPIO_Slave_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_Slave_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_Slave_0.tcl
