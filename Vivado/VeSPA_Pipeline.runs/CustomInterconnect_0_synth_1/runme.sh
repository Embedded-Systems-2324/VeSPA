...
HD_PWD='/home/joseleite/Vivado_Projects/Vivado/VeSPA_Pipeline.runs/CustomInterconnect_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CustomInterconnect_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CustomInterconnect_0.tcl
