...
--               /home/mariolima/Desktop/VESPA_SOC_V2/vespa_soc/vespa_soc.gen/sources_1/bd/vespa_soc/ip/vespa_soc_UartSlave_0_0/vespa_soc_UartSlave_0_0_sim_netlist.vhdl
...
entity vespa_soc_UartSlave_0_0_UartBaudRate is
  port (
  ...
  attribute ORIG_REF_NAME of vespa_soc_UartSlave_0_0_UartBaudRate : entity is "UartBaudRate";
end vespa_soc_UartSlave_0_0_UartBaudRate;

architecture STRUCTURE of vespa_soc_UartSlave_0_0_UartBaudRate is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vespa_soc_UartSlave_0_0_UartRx is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of vespa_soc_UartSlave_0_0_UartRx : entity is "UartRx";
end vespa_soc_UartSlave_0_0_UartRx;

architecture STRUCTURE of vespa_soc_UartSlave_0_0_UartRx is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vespa_soc_UartSlave_0_0_UartTx is
  port (
    o_Tx : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of vespa_soc_UartSlave_0_0_UartTx : entity is "UartTx";
end vespa_soc_UartSlave_0_0_UartTx;

architecture STRUCTURE of vespa_soc_UartSlave_0_0_UartTx is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vespa_soc_UartSlave_0_0_Uart is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of vespa_soc_UartSlave_0_0_Uart : entity is "Uart";
end vespa_soc_UartSlave_0_0_Uart;

architecture STRUCTURE of vespa_soc_UartSlave_0_0_Uart is
...
begin
  o_Err <= \^o_err\;
\_UartBaudRate\: entity work.vespa_soc_UartSlave_0_0_UartBaudRate
     port map (
...
\_UartRx\: entity work.vespa_soc_UartSlave_0_0_UartRx
     port map (
      D(7) => \_UartRx_n_0\,
      D(6) => \_UartRx_n_1\,
      D(5) => \_UartRx_n_2\,
...
\_UartTx\: entity work.vespa_soc_UartSlave_0_0_UartTx
     port map (
      Q(7 downto 0) => r_DataIn(7 downto 0),
      i_Rst => i_Rst,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vespa_soc_UartSlave_0_0 is
  port (
    i_Clk : in STD_LOGIC;
    i_Rst : in STD_LOGIC;
    i_WEnable : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of vespa_soc_UartSlave_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of vespa_soc_UartSlave_0_0 : entity is "vespa_soc_UartSlave_0_0,Uart,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of vespa_soc_UartSlave_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of vespa_soc_UartSlave_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of vespa_soc_UartSlave_0_0 : entity is "Uart,Vivado 2023.1";
end vespa_soc_UartSlave_0_0;

architecture STRUCTURE of vespa_soc_UartSlave_0_0 is
...
begin
inst: entity work.vespa_soc_UartSlave_0_0_Uart
     port map (
      i_Clk => i_Clk,
