...
#
# Script generated by Vivado on Fri Apr 12 10:27:11 WEST 2024
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/311c/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/311c/src" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/311c/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/311c/src" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/311c/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/311c/src" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/afonso/Documents/VeSPA-main/VeSPA-main/Vivado/vespa_soc/vespa_soc.cache/compile_simlib/xcelium"
  fi
