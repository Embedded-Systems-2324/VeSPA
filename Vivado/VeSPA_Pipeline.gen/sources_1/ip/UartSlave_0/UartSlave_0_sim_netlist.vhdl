...
-- Command     : write_vhdl -force -mode funcsim -rename_top UartSlave_0 -prefix
--               UartSlave_0_ vespa_soc_UartSlave_0_0_sim_netlist.vhdl
...
entity UartSlave_0_UartBaudRate is
  port (
...
end UartSlave_0_UartBaudRate;

architecture STRUCTURE of UartSlave_0_UartBaudRate is
...
end UartSlave_0_UartRx;

architecture STRUCTURE of UartSlave_0_UartRx is
...
end UartSlave_0_UartTx;

architecture STRUCTURE of UartSlave_0_UartTx is
...
end UartSlave_0_Uart;

architecture STRUCTURE of UartSlave_0_Uart is
...
begin
  o_Err <= \^o_err\;
\_UartBaudRate\: entity work.UartSlave_0_UartBaudRate
     port map (
...
\_UartRx\: entity work.UartSlave_0_UartRx
     port map (
      D(7) => \_UartRx_n_0\,
      D(6) => \_UartRx_n_1\,
      D(5) => \_UartRx_n_2\,
...
\_UartTx\: entity work.UartSlave_0_UartTx
     port map (
      Q(7 downto 0) => r_DataIn(7 downto 0),
      i_Rst => i_Rst,
...
entity UartSlave_0 is
  ...
  attribute NotValidForBitStream of UartSlave_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of UartSlave_0 : entity is "vespa_soc_UartSlave_0_0,Uart,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of UartSlave_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of UartSlave_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of UartSlave_0 : entity is "Uart,Vivado 2023.1";
end UartSlave_0;

architecture STRUCTURE of UartSlave_0 is
...
begin
inst: entity work.UartSlave_0_Uart
     port map (
      i_Clk => i_Clk,
