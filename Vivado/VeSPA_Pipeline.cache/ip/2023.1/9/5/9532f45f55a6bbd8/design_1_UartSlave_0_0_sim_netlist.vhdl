...
-- Date        : Tue Jun  4 19:04:36 2024
-- Host        : mariolima-CREF-XX running 64-bit Ubuntu 22.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_UartSlave_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UartRx is
  port (
    ...
    \o_RData_reg[2]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Uart is
  ...
  signal \o_RData[31]_i_11_n_0\ : STD_LOGIC;
  ...
  signal r_RAddr : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal r_REnable : STD_LOGIC;
...
\_UartRx\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UartRx
     port map (
      ...
      \o_RData_reg[2]\(1 downto 0) => r_RAddr(1 downto 0),
...
o_Err_i_10: unisim.vcomponents.LUT6
    generic map(
...
o_Err_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
o_Err_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
o_Err_i_9: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\o_RData[31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"04000404"
    )
        port map (
...
\o_RData[31]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\o_RData[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\o_RData[31]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\r_RAddr_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(0),
...
\r_RAddr_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(11),
...
\r_RAddr_reg[12]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(12),
...
\r_RAddr_reg[13]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(13),
...
\r_RAddr_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(14),
...
\r_RAddr_reg[15]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(15),
...
\r_RAddr_reg[16]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(16),
...
\r_RAddr_reg[17]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(17),
...
\r_RAddr_reg[18]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(18),
...
\r_RAddr_reg[19]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(19),
...
\r_RAddr_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(1),
...
\r_RAddr_reg[20]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(20),
...
\r_RAddr_reg[21]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(21),
...
\r_RAddr_reg[22]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(22),
...
\r_RAddr_reg[23]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(23),
...
\r_RAddr_reg[24]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(24),
...
\r_RAddr_reg[25]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(25),
...
\r_RAddr_reg[26]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(26),
...
\r_RAddr_reg[27]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(27),
...
\r_RAddr_reg[28]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(28),
...
\r_RAddr_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(29),
...
\r_RAddr_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(30),
...
\r_RAddr_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(31),
...
\r_RAddr_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(5),
...
\r_RAddr_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(6),
...
\r_RAddr_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(7),
...
\r_RAddr_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(8),
...
\r_RAddr_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_RAddr(9),
...
r_REnable_reg: unisim.vcomponents.FDRE
     port map (
      C => i_Clk,
      CE => '1',
      D => i_REnable,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_UartSlave_0_0,Uart,{}";
