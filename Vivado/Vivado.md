...
## Uart Axi
This folder contains all the vivado uart files. The uart IP repository is already added in the project but maybe the path is different so please check if it is presented in your IP catalog and if not add the uart repo repository.
