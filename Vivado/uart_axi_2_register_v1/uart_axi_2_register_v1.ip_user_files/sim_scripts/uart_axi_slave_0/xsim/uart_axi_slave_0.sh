...
#
# Script generated by Vivado on Sun Mar 03 17:53:06 WET 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : uart_axi_slave_0.sh
...
#
# Usage        : uart_axi_slave_0.sh
#                uart_axi_slave_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_axi_slave_0.sh [-reset_run]
#                uart_axi_slave_0.sh [-reset_log]
#                uart_axi_slave_0.sh [-help]
#
...
# script info
echo -e "uart_axi_slave_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_axi_slave_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uart_axi_slave_0 xil_defaultlib.uart_axi_slave_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uart_axi_slave_0 -key {Behavioral:sim_1:Functional:uart_axi_slave_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb uart_axi_slave_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_axi_slave_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_axi_slave_0.sh [-help]\n\
Usage: uart_axi_slave_0.sh [-step]\n\
Usage: uart_axi_slave_0.sh [-lib_map_path]\n\
Usage: uart_axi_slave_0.sh [-reset_run]\n\
Usage: uart_axi_slave_0.sh [-reset_log]\n\
Usage: uart_axi_slave_0.sh [-keep_index]\n\
Usage: uart_axi_slave_0.sh [-noclean_files]\n\n\
