...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8 -d "BUS_MSB=31" -d "BUS_WIDTH=32"  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CodeMemory xil_defaultlib.CodeMemory xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CodeMemory -key {Behavioral:sim_1:Functional:CodeMemory} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CodeMemory.wdb xsim.dir libdpi.so)
