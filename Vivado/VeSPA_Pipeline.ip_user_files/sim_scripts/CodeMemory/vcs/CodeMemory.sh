...
#
# Script generated by Vivado on Sun May 19 16:33:54 WEST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : CodeMemory.sh
...
#
# Usage        : CodeMemory.sh
#                CodeMemory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CodeMemory.sh [-reset_run]
#                CodeMemory.sh [-reset_log]
#                CodeMemory.sh [-help]
#
...
#                script (type 'CodeMemory.sh -help' for more information).
#
...
# script info
echo -e "CodeMemory.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CodeMemory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.CodeMemory xil_defaultlib.glbl -o CodeMemory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./CodeMemory_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariolima/Desktop/vespa_copy/vespa_git/VeSPA/Vivado/VeSPA_Pipeline.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key CodeMemory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc CodeMemory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CodeMemory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CodeMemory.sh [-help]\n\
Usage: CodeMemory.sh [-step]\n\
Usage: CodeMemory.sh [-lib_map_path]\n\
Usage: CodeMemory.sh [-reset_run]\n\
Usage: CodeMemory.sh [-reset_log]\n\
Usage: CodeMemory.sh [-keep_index]\n\
Usage: CodeMemory.sh [-noclean_files]\n\n\
