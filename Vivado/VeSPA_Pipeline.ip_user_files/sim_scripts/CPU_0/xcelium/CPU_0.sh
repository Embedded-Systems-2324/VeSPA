...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" \
  "../../../ipstatic/CPU_0/src/CodeMemory/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" \
