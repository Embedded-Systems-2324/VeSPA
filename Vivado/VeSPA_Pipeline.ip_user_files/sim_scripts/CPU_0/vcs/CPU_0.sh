...
#
# Script generated by Vivado on Mon Jun 03 00:04:48 WEST 2024
...
# script info
echo -e "CPU_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" \
  "../../../ipstatic/CPU_0/src/CodeMemory/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/ip/CPU_0/src" \
