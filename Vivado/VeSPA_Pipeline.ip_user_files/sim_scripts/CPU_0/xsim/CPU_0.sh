...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8 -d "BUS_MSB=31" -d "BUS_WIDTH=32"  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CPU_0 xil_defaultlib.CPU_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CPU_0 -key {Behavioral:sim_1:Functional:CPU_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
