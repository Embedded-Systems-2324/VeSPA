...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../bd/design_1/ipshared/ccbd/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/ccbd/src" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../bd/design_1/ipshared/ccbd/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/ccbd/src" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../bd/design_1/ipshared/ccbd/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/ccbd/src" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariolima/Desktop/vespa_teste/VeSPA/Vivado/VeSPA_Pipeline.cache/compile_simlib/xcelium"
  fi
