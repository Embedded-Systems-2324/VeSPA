...
#
# Script generated by Vivado on Mon Jun 03 00:27:43 WEST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/e61c/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/e61c/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/e61c/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/e61c/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/e61c/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/e61c/src" \
