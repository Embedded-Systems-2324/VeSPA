...
#
# Script generated by Vivado on Thu Jun 06 14:51:09 WEST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/c5c1/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/c5c1/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/c5c1/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/c5c1/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/c5c1/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/c5c1/src" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariolima/Desktop/vespa_git/VeSPA/Vivado/VeSPA_Pipeline.cache/compile_simlib/vcs"
  fi
