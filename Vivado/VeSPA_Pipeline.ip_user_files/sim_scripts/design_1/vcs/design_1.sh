...
#
# Script generated by Vivado on Wed Jun 05 00:37:49 WEST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/62f1/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/62f1/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/62f1/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/62f1/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../bd/design_1/ipshared/62f1/src" +incdir+"../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/62f1/src" \
