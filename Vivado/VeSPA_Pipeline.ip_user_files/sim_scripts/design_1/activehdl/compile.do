...
vlog -work xpm  -sv2k12  +define+BUS_MSB=31  +define+BUS_WIDTH=32 "+incdir+../../../bd/design_1/ipshared/e61c/src" "+incdir+../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/e61c/src" -l xpm -l xil_defaultlib -l blk_mem_gen_v8_4_6 \
...
vlog -work xil_defaultlib  -v2k5  +define+BUS_MSB=31  +define+BUS_WIDTH=32 "+incdir+../../../bd/design_1/ipshared/e61c/src" "+incdir+../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/e61c/src" -l xpm -l xil_defaultlib -l blk_mem_gen_v8_4_6 \
...
vlog -work blk_mem_gen_v8_4_6  -v2k5  +define+BUS_MSB=31  +define+BUS_WIDTH=32 "+incdir+../../../bd/design_1/ipshared/e61c/src" "+incdir+../../../../VeSPA_Pipeline.gen/sources_1/bd/design_1/ipshared/e61c/src" -l xpm -l xil_defaultlib -l blk_mem_gen_v8_4_6 \
