...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8 -d "BUS_MSB=31" -d "BUS_WIDTH=32"  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot UartSlave_0 xil_defaultlib.UartSlave_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim UartSlave_0 -key {Behavioral:sim_1:Functional:UartSlave_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb UartSlave_0.wdb xsim.dir libdpi.so)
