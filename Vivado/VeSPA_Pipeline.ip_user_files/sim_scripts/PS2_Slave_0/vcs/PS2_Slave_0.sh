...
#
# Script generated by Vivado on Thu May 23 14:32:49 WEST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : PS2_Slave_0.sh
...
#
# Usage        : PS2_Slave_0.sh
#                PS2_Slave_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PS2_Slave_0.sh [-reset_run]
#                PS2_Slave_0.sh [-reset_log]
#                PS2_Slave_0.sh [-help]
#
...
#                script (type 'PS2_Slave_0.sh -help' for more information).
#
...
# script info
echo -e "PS2_Slave_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PS2_Slave_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PS2_Slave_0 xil_defaultlib.glbl -o PS2_Slave_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PS2_Slave_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key PS2_Slave_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PS2_Slave_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PS2_Slave_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PS2_Slave_0.sh [-help]\n\
Usage: PS2_Slave_0.sh [-step]\n\
Usage: PS2_Slave_0.sh [-lib_map_path]\n\
Usage: PS2_Slave_0.sh [-reset_run]\n\
Usage: PS2_Slave_0.sh [-reset_log]\n\
Usage: PS2_Slave_0.sh [-keep_index]\n\
Usage: PS2_Slave_0.sh [-noclean_files]\n\n\
