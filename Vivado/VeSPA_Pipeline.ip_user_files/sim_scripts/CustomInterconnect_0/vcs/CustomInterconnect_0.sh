...
#
# Script generated by Vivado on Thu May 23 14:32:22 WEST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : CustomInterconnect_0.sh
...
#
# Usage        : CustomInterconnect_0.sh
#                CustomInterconnect_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CustomInterconnect_0.sh [-reset_run]
#                CustomInterconnect_0.sh [-reset_log]
#                CustomInterconnect_0.sh [-help]
#
...
#                script (type 'CustomInterconnect_0.sh -help' for more information).
#
...
# script info
echo -e "CustomInterconnect_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CustomInterconnect_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+BUS_MSB="31" +define+BUS_WIDTH="32" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.CustomInterconnect_0 xil_defaultlib.glbl -o CustomInterconnect_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./CustomInterconnect_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/joseleite/Vivado_Projects/Vivado/VeSPA_Pipeline.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key CustomInterconnect_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc CustomInterconnect_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CustomInterconnect_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CustomInterconnect_0.sh [-help]\n\
Usage: CustomInterconnect_0.sh [-step]\n\
Usage: CustomInterconnect_0.sh [-lib_map_path]\n\
Usage: CustomInterconnect_0.sh [-reset_run]\n\
Usage: CustomInterconnect_0.sh [-reset_log]\n\
Usage: CustomInterconnect_0.sh [-keep_index]\n\
Usage: CustomInterconnect_0.sh [-noclean_files]\n\n\
