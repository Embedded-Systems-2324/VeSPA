...
#
# Script generated by Vivado on Tue May 21 11:42:08 WEST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+BUS_MSB="31" +define+BUS_WIDTH="32" +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../ipstatic" \
