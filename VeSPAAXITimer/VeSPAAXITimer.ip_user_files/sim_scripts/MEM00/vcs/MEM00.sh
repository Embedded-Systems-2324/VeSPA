...
#
# Script generated by Vivado on Sun Jan 28 01:48:11 WET 2024
...
#
# Usage        : MEM00.sh
#                MEM00.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MEM00.sh [-reset_run]
#                MEM00.sh [-reset_log]
#                MEM00.sh [-help]
#
...
#                script (type 'MEM00.sh -help' for more information).
#
...
# script info
echo -e "MEM00.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MEM00.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MEM00 xil_defaultlib.glbl -o MEM00_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MEM00_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariolima/Desktop/VESPA_BHV1.0/VESPA_BHV.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key MEM00_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MEM00_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MEM00.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MEM00.sh [-help]\n\
Usage: MEM00.sh [-step]\n\
Usage: MEM00.sh [-lib_map_path]\n\
Usage: MEM00.sh [-reset_run]\n\
Usage: MEM00.sh [-reset_log]\n\
Usage: MEM00.sh [-keep_index]\n\
Usage: MEM00.sh [-noclean_files]\n\n\
