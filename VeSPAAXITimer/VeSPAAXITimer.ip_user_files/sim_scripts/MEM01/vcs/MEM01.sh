...
#
# Usage        : MEM01.sh
#                MEM01.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MEM01.sh [-reset_run]
#                MEM01.sh [-reset_log]
#                MEM01.sh [-help]
#
...
#                script (type 'MEM01.sh -help' for more information).
#
...
# script info
echo -e "MEM01.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MEM01.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MEM01 xil_defaultlib.glbl -o MEM01_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MEM01_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MEM01_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MEM01_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MEM01.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MEM01.sh [-help]\n\
Usage: MEM01.sh [-step]\n\
Usage: MEM01.sh [-lib_map_path]\n\
Usage: MEM01.sh [-reset_run]\n\
Usage: MEM01.sh [-reset_log]\n\
Usage: MEM01.sh [-keep_index]\n\
Usage: MEM01.sh [-noclean_files]\n\n\
