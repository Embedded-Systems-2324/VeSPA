...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.VeSPA_AXI_Timer xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.VeSPA_AXI_Timer -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luizalex/VeSPAAXITimer/VeSPAAXITimer.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log VeSPA_AXI_Timer_sc.so .tmp_log xcelium_lib waves.shm c.obj)
