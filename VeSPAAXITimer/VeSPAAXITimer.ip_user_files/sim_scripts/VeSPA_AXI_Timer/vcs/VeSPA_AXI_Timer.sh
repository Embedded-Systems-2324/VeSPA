...
#                script (type 'VeSPA_AXI_Timer.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.VeSPA_AXI_Timer xil_defaultlib.glbl -o VeSPA_AXI_Timer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./VeSPA_AXI_Timer_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luizalex/VeSPAAXITimer/VeSPAAXITimer.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key VeSPA_AXI_Timer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc VeSPA_AXI_Timer_simv.daidir vcs_lib c.obj)
