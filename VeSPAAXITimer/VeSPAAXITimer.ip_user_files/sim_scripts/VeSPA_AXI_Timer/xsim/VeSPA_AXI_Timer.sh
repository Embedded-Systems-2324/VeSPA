...
#
# Script generated by Vivado on Fri Mar 08 00:11:33 WET 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : VeSPA_AXI_Timer.sh
...
#
# Usage        : VeSPA_AXI_Timer.sh
#                VeSPA_AXI_Timer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VeSPA_AXI_Timer.sh [-reset_run]
#                VeSPA_AXI_Timer.sh [-reset_log]
#                VeSPA_AXI_Timer.sh [-help]
#
...
# script info
echo -e "VeSPA_AXI_Timer.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VeSPA_AXI_Timer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot VeSPA_AXI_Timer xil_defaultlib.VeSPA_AXI_Timer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim VeSPA_AXI_Timer -key {Behavioral:sim_1:Functional:VeSPA_AXI_Timer} -tclbatch cmd.tcl -protoinst "protoinst_files/VeSPA_AXI_Timer.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb VeSPA_AXI_Timer.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./VeSPA_AXI_Timer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: VeSPA_AXI_Timer.sh [-help]\n\
Usage: VeSPA_AXI_Timer.sh [-step]\n\
Usage: VeSPA_AXI_Timer.sh [-lib_map_path]\n\
Usage: VeSPA_AXI_Timer.sh [-reset_run]\n\
Usage: VeSPA_AXI_Timer.sh [-reset_log]\n\
Usage: VeSPA_AXI_Timer.sh [-keep_index]\n\
Usage: VeSPA_AXI_Timer.sh [-noclean_files]\n\n\
