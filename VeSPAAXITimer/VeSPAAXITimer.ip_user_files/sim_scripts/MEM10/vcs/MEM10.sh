...
#
# Script generated by Vivado on Sun Jan 28 01:48:12 WET 2024
...
#
# Usage        : MEM10.sh
#                MEM10.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MEM10.sh [-reset_run]
#                MEM10.sh [-reset_log]
#                MEM10.sh [-help]
#
...
#                script (type 'MEM10.sh -help' for more information).
#
...
# script info
echo -e "MEM10.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MEM10.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MEM10 xil_defaultlib.glbl -o MEM10_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MEM10_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MEM10_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MEM10_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MEM10.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MEM10.sh [-help]\n\
Usage: MEM10.sh [-step]\n\
Usage: MEM10.sh [-lib_map_path]\n\
Usage: MEM10.sh [-reset_run]\n\
Usage: MEM10.sh [-reset_log]\n\
Usage: MEM10.sh [-keep_index]\n\
Usage: MEM10.sh [-noclean_files]\n\n\
