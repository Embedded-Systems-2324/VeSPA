...
HD_PWD='/home/mariolima/Desktop/VESPA_BHV1.0/VESPA_BHV.runs/MEM00_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MEM00.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MEM00.tcl
