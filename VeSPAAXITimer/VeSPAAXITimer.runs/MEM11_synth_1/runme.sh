...
HD_PWD='/home/mariolima/Desktop/VESPA_BHV1.0/VESPA_BHV.runs/MEM11_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MEM11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MEM11.tcl
