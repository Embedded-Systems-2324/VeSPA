...
HD_PWD='/home/mariolima/Desktop/VESPA_BHV1.0/VESPA_BHV.runs/MEM10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MEM10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MEM10.tcl
