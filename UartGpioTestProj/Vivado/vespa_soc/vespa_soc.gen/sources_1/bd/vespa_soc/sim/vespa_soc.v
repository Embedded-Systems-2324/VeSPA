...
module vespa_soc
  ...
  assign CLK_1 = CLK;
  assign PS2_OutData[3:0] = PS2_0_o_Data;
  assign RST_1 = RST;
  assign Tx = UartSlave_0_o_Tx;
  assign i_Ps2Clk_0_1 = i_Ps2Clk;
  assign i_Ps2Sda_0_1 = i_Ps2Sda;
  assign i_Rx_0_1 = Rx;
  ...
  vespa_soc_PS2_0_0 PS2_0
       (.i_Clk(vespa_cpu_0_o_Clk),
        .i_Ps2Clk(i_Ps2Clk_0_1),
        .i_Ps2Sda(i_Ps2Sda_0_1),
