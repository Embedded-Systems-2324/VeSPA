...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vespa_soc xil_defaultlib.vespa_soc xil_defaultlib.glbl -log elaborate.log
}
