...
#
# Script generated by Vivado on Mon Apr 22 14:18:51 WEST 2024
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" +incdir+"../../../../vespa_soc.gen/sources_1/bd/vespa_soc/ipshared/a957/src" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bruno/gitreps/VeSPA_UartTest/Vivado/vespa_soc/vespa_soc.cache/compile_simlib/xcelium"
  fi
